...
export function Layout() {
  ...
  return (
    <div className="flex min-h-screen">
      ...
      <Sidebar />
      {/* min-w-0 is essential: without it a flex child won't shrink below its
      ...
      {/* .pwa-top adds status-bar clearance only in installed-PWA (standalone)
          mode — see index.css @media (display-mode: standalone). A normal
          browser keeps the plain py-6, so desktop/web is unchanged. */}
      <main
        id="main-content"
        className="pwa-top flex-1 min-w-0 px-4 sm:px-6 lg:px-10 py-6 max-w-[1600px] mx-auto w-full"
      >
        {session ? (
